...
public class Screenshots {
	...
	public void screenshots(WebDriver driver) throws IOException {
		...
		String screenshotDestination = syspath + "\\src\\test\\resources\\Screenshot\\imagename_" + dateAndTime
				+ ".jpg";
	...
	public void failureScreenshot(WebDriver driver, String tagname) throws IOException {
		...
		File screenshotFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		String fileDestination = syspath + "\\src\\test\\resources\\Screenshot\\imagename_" + tagname + dateAndTime
				+ ".jpg";
